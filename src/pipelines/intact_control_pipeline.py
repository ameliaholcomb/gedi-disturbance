...
def run_main(shots_dir=None, out_dir=None):
    ...
    shots_df = degradation_overlap.run_degradation_overlay(
        ...
        out_schema=jrc_parser.out_schema_undisturbed,
        degradation_overlay_fn=jrc_parser.filter_undisturbed_shot_pairs,
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Find GEDI shot pairs in intact regions, as identified by the JRC product."
    )
    parser.add_argument(
        "--shots_dir",
        "-s",
